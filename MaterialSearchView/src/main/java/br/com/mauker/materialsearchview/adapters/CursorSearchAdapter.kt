...
open class CursorSearchAdapter @JvmOverloads constructor(
    ...
    private inner class ListViewHolder internal constructor(convertView: View) {
        ...
        private val tv_title: TextView = convertView.findViewById(R.id.tv_str)
        private val tv_subtitle: TextView = convertView.findViewById(R.id.tv_subtitle)
...
data class SearchHistoryItem(val text: String, val subtitle: String = "", val isHistory: Boolean)
